                        ...
                        <FieldArray name="guest_rooms" v-slot="{ fields, push, remove }">
                            <tr v-for="(field, index) in fields" :key="index">
                                ...
                                <td>
                                    <Field
                                        type="text"
                                        :id="`guest_rooms-${index}-id_number`"
