...
const createAgreement = () => {
    form.post(route('backoffice.agreements.store'), {
...
<template>
    ...
    <BackofficeLayout :breadcrumbs="breadcrumbs" title="New Agreement">
        <div class="space-y-4">
            <div class="card bg-base-100 shadow">
                <div class="card-body lg-p-6 p-2 sm:p-4">
                    <form @submit.prevent="createAgreement" class="grid grid-cols-1 gap-4" novalidate>
                        <div class="space-y-2">
