...
import useUpsertQuotation from '@/composables/useUpsertQuotation';
...
const handleClientUpdated = ({ client: customer }) => {
    ...
    form.transform((data) => {
        data.items = filteredItems.value.map((item) => {
            return {
                ...
                tax_rate: item.taxable ? item.item.tax_rate : 0,
            };
        });
        ...
        return data;
    }).post(route('backoffice.quotations.store'), {
        onError: (errors) => {
...
<template>
        ...
        <div class="drawer-content flex min-h-screen flex-col bg-[#e7d7be] md:max-h-screen">
            ...
            <div class="flex h-full flex-col gap-2 p-2">
                <div ref="titleElement" class="flex flex-wrap items-center justify-between gap-2">
                    <h2 class="text-xl font-semibold">Create Quotation</h2>
                        ...
                        <div class="col-span-12 md:col-span-9">
                            <div class="card bg-[#00ff01] shadow">
                                <div class="card-body space-y-2 p-1 pb-4">
                                    <h2 class="text-xl font-bold">New Quotation Summary</h2>
                                        ...
                                        <table class="table-xs table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <th>Customer</th>
                                                    <td>
                                                        <div class="join w-full" @click="openQuotationCustomerDialog">
                                                            <div>
    ...
    <teleport to="body">
        ...
        <dialog ref="quotationCustomerDialog" class="modal">
            <select-client-component :client="null" @client-updated="handleClientUpdated" @close-dialog="closeQuotationCustomerDialog" />
        </dialog>
    </teleport>
</template>
