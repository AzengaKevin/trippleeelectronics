...
const submit = () => {
    form.transform((data) => {
        ...
        return data;
    }).post(route('backoffice.orders.store'), {
        onError: (errors) => {
...
<template>
                        ...
                        <div class="col-span-12 md:col-span-9">
                            <div class="card bg-[#00ff01] shadow">
                                <div class="card-body space-y-2 p-1 pb-4">
                                    <h2 class="text-xl font-bold">New Order Summary</h2>
                                    ...
                                    <div class="grid grid-cols-3 gap-2">
                                        <button
                                            ...
                                            :class="[
                                                ...
                                                {
                                                    'hover:bg-primary hover:text-white': form.processing || !itemsSetupProperly,
    ...
    <teleport to="body">
        ...
        <dialog ref="orderCustomerDialog" class="modal">
            <order-customer-component @order-customer-updated="handleOrderCustomerUpdated" @close-dialog="closeOrderCustomerDialog" />
        </dialog>
    </teleport>
</template>
