...
<template>
    ...
    <BackofficeLayout :breadcrumbs="breadcrumbs" title="Reports">
        <div class="space-y-4">
                    ...
                    <div class="card bg-[#87ceeb]">
                        <div class="card-body space-y-4">
                            ...
                            <div class="flex flex-wrap gap-3">
                                <Link :href="route('backoffice.reports.index')" class="btn btn-sm btn-primary btn-outline rounded-full">
                                ...
                                <a
                                    target="_blank"
                                    v-if="auth.permissions.includes('print-reports')"
                                    :href="route('backoffice.reports.print', { ...filters })"
