...
const breadcrumbs = [
    ...
    { title: props.room.name, href: route('backoffice.rooms.show', props.room.id) },
    { title: 'Edit', href: null },
];

const form = useForm({
    building: props.room.building_id,
    room_type: props.room.room_type_id,
...
const submitForm = () => {
    form.put(route('backoffice.rooms.update', props.room.id), {
        onError: (errors) => {
...
<template>
    ...
    <BackofficeLayout :breadcrumbs="breadcrumbs" title="Edit Room">
