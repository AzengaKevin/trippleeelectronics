...
const createStockLevel = () => {
    form.transform((data) => {
        ...
        return data;
    }).post(route('backoffice.stock-levels.store'), {
        onSuccess: () => {
            form.reset();
        },
        onError: (errors) => {
...
<template>
    <Head>
        <title>Create Stock Level</title>
    </Head>

    <BackofficeLayout :breadcrumbs="breadcrumbs" title="Create Stock Level">
        <div class="space-y-4">
            <div class="card bg-base-100 shadow">
                <div class="card-body lg-p-6 p-2 sm:p-4">
                    <form @submit.prevent="createStockLevel" class="grid grid-cols-1 gap-4" novalidate>
                        <!-- Item -->
                        <div class="space-y-2">
