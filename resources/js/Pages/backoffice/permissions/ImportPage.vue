...
const importPermissions = () => {
    form.post(route('backoffice.permissions.import'), {
...
<template>
    <Head>
        <title>Import Permissions</title>
    </Head>

    <BackofficeLayout :breadcrumbs="breadcrumbs" title="Import Permissions">
        <div class="space-y-4">
            <AppAlert :feedback="feedback" />
            <div class="card bg-base-100 shadow">
                <div class="card-body lg-p-6 p-2 sm:p-4">
                    <form @submit.prevent="importPermissions" class="grid grid-cols-1 gap-4" novalidate>
                        <div class="space-y-2">
                            ...
                            <div class="text-sm">
                                ...
                                <a :href="route('backoffice.permissions.export', { limit: 1 })" download class="text-primary underline"> here </a>
                            </div>
