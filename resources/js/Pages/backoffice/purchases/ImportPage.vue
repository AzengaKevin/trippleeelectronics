...
const importPurchases = () => {
    form.post(route('backoffice.purchases.import'), {
        onSuccess: () => {
            form.reset();
        },
        onError: (errors) => {
...
<template>
    <Head>
        <title>Import Purchases</title>
    </Head>

    <BackofficeLayout :breadcrumbs="breadcrumbs" title="Import Purchases">
        <div class="space-y-4">
            <AppAlert :feedback="feedback" />
            <div class="card bg-blue-500 shadow">
                <div class="card-body lg-p-6 p-2 sm:p-4">
                    <form @submit.prevent="importPurchases" class="grid grid-cols-1 gap-4" novalidate>
                        <div class="space-y-2">
                            ...
                            <div class="text-sm">
                                ...
                                <a :href="route('backoffice.purchases.export', { limit: 1 })" download class="text-primary underline"> here </a>
                            </div>
