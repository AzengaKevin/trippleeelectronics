...
const breadcrumbs = [
    ...
    },
    {
        ...
        href: route('backoffice.item-variants.show', [props.itemVariant.id]),
    },
    {
        title: 'Edit',
        href: null,
...
const form = useForm({
    item: props.itemVariant.item_id,
    attribute: props.itemVariant.attribute,
    value: props.itemVariant.value,
    name: props.itemVariant.name,
    pos_name: props.itemVariant.pos_name,
    image: null,
    price: props.itemVariant.price,
    cost: props.itemVariant.cost,
    quantity: props.itemVariant.quantity,
    description: props.itemVariant.description,
    pos_description: props.itemVariant.pos_description,
});

const updateVariant = () => {
    form.transform((data) => ({ ...data, _method: 'patch' })).post(route('backoffice.item-variants.update', [props.itemVariant.id]), {
        onSuccess: () => {
            form.reset();
        },
        onError: (errors) => {
...
<template>
    <Head>
        <title>Edit Item Variant</title>
    </Head>

    <BackofficeLayout :breadcrumbs="breadcrumbs" title="Edit Item Variant">
        <div class="space-y-4">
            <div class="card bg-base-100 shadow">
                <div class="card-body lg-p-6 p-2 sm:p-4">
                    <form @submit.prevent="updateVariant" class="grid grid-cols-1 gap-4" novalidate>
                        <!-- Item -->
                        <div class="space-y-2">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea
                                ...
                                placeholder="POS Variant Description"
                            ></textarea>
