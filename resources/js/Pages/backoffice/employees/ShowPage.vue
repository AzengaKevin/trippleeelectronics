...
<template>
    ...
    <BackofficeLayout :breadcrumbs="breadcrumbs" title="Employee Details">
        <div class="space-y-4">
            <div class="flex flex-wrap items-center gap-3">
                <Link
                    v-if="auth.permissions?.includes('update-employees')"
                    :href="route('backoffice.employees.edit', [employee.id])"
                                            ...
                                            <table class="table-xs table">
                                                ...
                                                <tbody>
                                                    <tr v-for="(media, index) in employee.media">
                                                        ...
                                                        <td>{{ media.size ?? '-' }}</td>
                                                        <td>{{ formatDate(media.created_at, 'YY-MM-DD HH:mm:ss') }}</td>
                                                        <td>
