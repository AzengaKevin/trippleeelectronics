...
const importItemCategories = () => {
    form.post(route('backoffice.organization-categories.import'), {
        onSuccess: () => {
            form.reset();
        },
        onError: (errors) => {
...
<template>
    <Head>
        <title>Import Organization Categories</title>
        <meta name="description" content="Item categories import page" />
    </Head>

    <BackofficeLayout :breadcrumbs="breadcrumbs" title="Import Organization Categories">
        <div class="space-y-4">
